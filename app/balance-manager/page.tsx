...
export default function BalanceManagerPage() {
    ...
    //     // This would typically open a deposit modal or redirect to a deposit page
    //     alert(`Deposit to balance manager ${id}`)
    // }
    ...
    return (
        <div className="container mx-auto px-6 py-12 max-w-5xl">
            <h1 className="text-4xl font-bold mb-3">Balance Manager</h1>
            <p className="text-muted-foreground mb-12 text-lg">Manage your on-chain balances for gaming</p>

            {balanceManagers.length > 0 ? (
                <div className="grid gap-12">
                    <Card className="shadow-sm">
                        <CardHeader>
                            <CardTitle className="text-2xl">Current Balance Manager</CardTitle>
                            <CardDescription className="text-base">Your currently selected balance manager for games</CardDescription>
                        </CardHeader>
                        <CardContent>
                            {selectedManager && (
                                    ...
                                    <div className="p-6">
                                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="font-medium text-lg">{selectedManager.address}</p>
                                                    <p className="text-muted-foreground">Active Balance Manager</p>
                                                </div>
                                            </div>
                                            <div className="w-full md:w-auto">
                                                <div className="font-bold text-2xl text-center md:text-right">
                                                    {selectedManager.balance.toFixed(2)} ETH
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="border-t bg-muted/10 p-4 flex flex-col sm:flex-row gap-3 justify-end">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="md:col-span-2">
                            <Card className="shadow-sm h-full">
                                <CardHeader>
                                    <CardTitle className="text-2xl">Your Balance Managers</CardTitle>
                                ...
                                <CardContent>
                                    <div className="grid gap-6">
                                        {balanceManagers.map((manager) => (
                                            <div
                                                key={manager.id}
                                                className={`flex flex-col md:flex-row justify-between items-start md:items-center gap-6 p-6 border rounded-lg ${manager.selected ? "border-primary bg-primary/5" : ""
                                                    }`}
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className="font-medium text-lg">{manager.address}</p>
                                ...
                                <CardFooter className="flex flex-col items-start pt-6">
                                    <div
                                        ...
                                        className="flex flex-col w-full md:flex-row justify-between items-start md:items-center gap-6 p-6 border-2 border-dashed rounded-lg hover:bg-muted/10 transition-colors cursor-pointer"
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className="bg-muted p-3 rounded-full">
                        ...
                        <div>
                            <Card className="shadow-sm h-full">
                                <CardHeader>
                                    <CardTitle className="text-xl">About Balance Managers</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div>
                                        <h3 className="text-lg font-medium mb-3">What is a Balance Manager?</h3>
                                        <p className="text-muted-foreground">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-medium mb-3">How They Work With Games</h3>
                                    ...
                                    <Alert>
                                        ...
                                        <AlertDescription>
                                            You can switch between balance managers at any time, but only the selected manager will be used
                                            for new games.
                                        </AlertDescription>
                                    </Alert>
                                </CardContent>
                ...
                <Card className="shadow-sm">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-2xl">Welcome to Balance Managers</CardTitle>
                        <CardDescription className="text-base">
                    ...
                    <CardContent className="space-y-10 pt-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="md:col-span-2">
                                <div className="bg-muted/30 p-8 rounded-lg h-full">
                                    <h3 className="text-xl font-medium mb-6">What is a Balance Manager?</h3>
                                    <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                                        A Balance Manager is an on-chain object that holds your balance for gaming. Each balance manager has
                                        a unique address and maintains its own balance, allowing you to separate and manage your gaming
                                        funds.
                                    </p>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                                        <div className="p-6 border rounded-lg bg-background">
                                            <h4 className="font-medium text-lg mb-3">Secure Gaming</h4>
                                            <p className="text-muted-foreground">
                                                Keep your gaming funds separate from your main wallet for added security.
                                            </p>
                                        </div>
                                        <div className="p-6 border rounded-lg bg-background">
                                            <h4 className="font-medium text-lg mb-3">Multiple Balances</h4>
                                            <p className="text-muted-foreground">
                            ...
                            <div>
                                <div className="bg-muted/30 p-8 rounded-lg h-full">
                                    <h4 className="font-medium text-lg mb-3">Easy Switching</h4>
                        ...
                        <div className="border-t pt-8">
                            <h3 className="text-xl font-medium mb-6">Create Your First Balance Manager</h3>
